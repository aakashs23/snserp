...
export default function ActivityLogsPage() {
  ...
  const getActionIcon = (action: string) => {
    ...
    if (act.includes("delete")) return <ShieldAlert className="size-4 text-destructive" />
    if (act.includes("document") || act.includes("invoice")) return <FileText className="size-4 text-primary" />
    if (act.includes("login")) return <LogIn className="size-4 text-chart-2" />
    if (act.includes("user")) return <UserIcon className="size-4 text-chart-4" />
